<?php namespace BankDev\Generators\Commands;

use BankDev\Generators\Generators\ResourceGenerator;
use BankDev\Generators\Cache;
...
class ResourceGeneratorCommand extends Command {
   ...
   protected function generateController()
    ...
    protected function generateViews()
    {
        ...
        if (get_called_class() === 'BankDev\\Generators\\Commands\\ScaffoldGeneratorCommand')
        {
            $views[] = 'scaffold';
